...
하지만 자리배치에 기본으로 쓰이는 백트래킹 알고리즘으로는 학생 수가 20명만 되어도 계산이 며칠씩 걸리는등, 사실상 프로그램 사용이 불가능할 정도의 계산 복잡도를 보였습니다.
하지만 Brach&Bound 알고리즘을 활용하면 20명의 학생을 대상으로 짧게는 몇초, 길게는 1분으로 시간을 매우 짧게 단축시킬 수 있었습니다. 
